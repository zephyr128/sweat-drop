...
export const translations = {
  en: {
    ...
    joinPage: {
      ...
      subtitle: 'Earn drops every time you train. Compete on the leaderboard. Win real prizes.',
  ...
  sr: {
    ...
    joinPage: {
      ...
      subtitle: 'Zarađuj kapi svaki put kad treniraš. Takmiči se na rang listi. Osvajaj nagrade.',
