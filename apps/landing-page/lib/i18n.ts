...
export const translations = {
  en: {
    ...
    membersHero: {
      ...
      subtitle: 'Connect to any machine. Earn drops every time you train.\nClimb your gym\'s leaderboard. Win real prizes every week.',
    ...
    joinPage: {
      ...
      inviteMessage: '{referrer} invites you to {gym}!',
      inviteMessageNoReferrer: 'You\'ve been invited to {gym}!',
      inviteMessageGeneric: 'You\'ve been invited to join SweatDrop!',
      subtitle: 'Earn drops every time you train. Compete on the leaderboard. Win real prizes at your gym.',
      howItWorksTitle: 'How it works',
      steps: [
        { label: 'Download the app and enter this invite code' },
        { label: 'Scan the QR code at the gym front desk to check in' },
        { label: 'You both earn bonus drops — you for joining, your friend for inviting you' },
      ],
      openInApp: 'Open in App',
      downloadApp: 'Download the App',
      appStore: 'App Store',
      googlePlay: 'Google Play',
      orDownload: 'Don\'t have the app yet?',
      alreadyHaveApp: 'Already have SweatDrop?',
      codeLabel: 'Your invite code',
      codeCopied: 'Copied!',
      afterInstall: 'After installing, open the app and tap "I have an invite code"',
      expired: {
        title: 'Invite Expired',
        message: 'This invite link has expired. Ask your friend to send a new one.',
      },
      invalid: {
      ...
      used: {
        ...
        message: 'This invite has already been claimed. Ask your friend to send a new one.',
      },
      loading: 'Loading invite...',
      poweredBy: 'Powered by SweatDrop',
    },
  },
  sr: {
    hero: {
    ...
    membersHero: {
      ...
      subtitle: 'Skeniraj QR na spravi. Zarađuj kapi svaki put kad treniraš.\nPenji se na rang listu svoje teretane. Osvajaj nagrade svake nedelje.',
    ...
    joinPage: {
      title: 'Pozvan/a si!',
      inviteMessage: '{referrer} te poziva u {gym}!',
      inviteMessageNoReferrer: 'Pozvan/a si u {gym}!',
      inviteMessageGeneric: 'Pozvan/a si da se pridružiš SweatDrop-u!',
      subtitle: 'Zarađuj kapi svaki put kad treniraš. Takmiči se na rang listi. Osvajaj nagrade u svojoj teretani.',
      howItWorksTitle: 'Kako funkcioniše',
      steps: [
        { label: 'Preuzmi aplikaciju i unesi ovaj pozivni kod' },
        { label: 'Skeniraj QR kod na recepciji teretane kad dođeš na trening' },
        { label: 'Oboje dobijate bonus kapi — ti što si se pridružio/la, tvoj prijatelj što te je pozvao' },
      ],
      openInApp: 'Otvori u aplikaciji',
      downloadApp: 'Preuzmi aplikaciju',
      appStore: 'App Store',
      googlePlay: 'Google Play',
      orDownload: 'Nemaš još aplikaciju?',
      alreadyHaveApp: 'Već imaš SweatDrop?',
      codeLabel: 'Tvoj pozivni kod',
      codeCopied: 'Kopirano!',
      afterInstall: 'Nakon instalacije, otvori aplikaciju i klikni "Imam pozivni kod"',
      expired: {
        title: 'Poziv je istekao',
        message: 'Ovaj pozivni link je istekao. Zamoli prijatelja da ti pošalje novi.',
      },
      invalid: {
        title: 'Neispravan poziv',
        message: 'Ovaj pozivni link nije ispravan. Proveri link i pokušaj ponovo.',
      },
      used: {
        title: 'Poziv je već iskorišćen',
        message: 'Ovaj poziv je već preuzet. Zamoli prijatelja da ti pošalje novi.',
      },
      loading: 'Učitavanje poziva...',
      poweredBy: 'Pokreće SweatDrop',
    },
  },
} as const;
