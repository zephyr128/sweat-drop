...
import { Tag, Users, BarChart3 } from 'lucide-react';
import { useLanguage } from '@/lib/use-language';

const icons = [Tag, Users, BarChart3];

export const HowArenaWorks = memo(function HowArenaWorks() {
  const { t } = useLanguage();
  const steps = useMemo(() => t.howArenaWorks.steps.map((step, index) => ({
    ...step,
    icon: icons[index],
  })), [t]);
  return (
              ...
              >
                ...
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-16 h-16 rounded-full bg-orange/20 border-2 border-orange flex items-center justify-center">
                    <span className="display text-3xl text-orange">{step.number}</span>
                  </div>
                ...
                {/* Icon */}
                <div className="mb-6">
                  <div className="w-12 h-12 rounded-lg bg-orange/10 border border-orange/20 flex items-center justify-center">
