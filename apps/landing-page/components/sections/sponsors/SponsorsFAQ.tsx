...
export const SponsorsFAQ = memo(function SponsorsFAQ() {
  const { t } = useLanguage();
  const [openIndex, setOpenIndex] = useState<number | null>(null);
  const faqs = t.sponsorsFAQ.items;
          ...
          {faqs.map((faq, index) => (
            ...
            >
              <button
                ...
                className="w-full flex items-center justify-between p-6 text-left hover:bg-bg-card2 transition-colors"
              >
