...
export interface BadgeRingProps {
...
export function BadgeRing({ completedCount, totalCount, earnedBadgeCount, active, onPress }: BadgeRingProps) {
...
const styles = StyleSheet.create({
  ...
  badgeName: {
    ...fontStyles.body,
    fontSize: 12,
    color: hexToRgba(BADGE_COLOR, 0.65),
    textAlign: 'center',
    letterSpacing: 0.5,
    marginTop: 2,
  },
