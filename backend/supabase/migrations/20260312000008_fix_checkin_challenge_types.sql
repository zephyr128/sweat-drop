-- ═══════════════════════════════════════════════════════════
-- Migration: 20260312000008_fix_checkin_challenge_types.sql
...
-- Reference: docs/plans/fix_challenge_system_urgent.md — Phase 2
--
...
--
-- CHANGES:
--   - Fix existing challenge_type values using criteria JSONB
--   - update_challenge_progress(): exclude checkin_streak/checkin_count
--   - update_checkin_challenge_progress(): award rewards + handle NULL end_date
--   - Reset incorrect progress for affected challenges
--
-- IMPACT ON FRONTEND:
--   - Mobile: Check-in challenges will now be properly tracked and rewarded
--   - Admin: Must stop mapping checkin types (Phase 1 fix)
--
