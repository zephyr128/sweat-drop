-- Migration: 20260330000007_fix_award_drops_machine_type_column.sql
-- Description: Fix m.machine_type → m.type in award_drops().
--   The machines table column is "type", not "machine_type".
--   This caused award_drops() to error out when resolving the machine type fallback.
