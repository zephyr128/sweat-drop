-- Staff Roles and Machine Maintenance System
-- Adds receptionist role permissions, staff management, and machine maintenance reporting

-- 1. Ensure receptionist role exists in user_role enum (should already exist from previous migrations)
-- No need to alter enum if it already exists

-- 2. Create machine_reports table for user-reported issues
...
-- 3. Add maintenance flag to machines table
...
-- 5. Enable RLS for machine_reports
...
-- 6. Create staff_invitations table for team management
...
-- 7. Create indexes for staff_invitations
...
-- 8. Enable RLS for staff_invitations
...
-- 9. Function to accept staff invitation
...
-- 10. Function to get machines with active reports
