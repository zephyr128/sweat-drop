-- ═══════════════════════════════════════════════════════════
-- Migration: 20260312000012_fix_live_status_remove_average_rpm.sql
-- Description: Fix get_live_machine_status — sessions table has no
--   average_rpm column. Use machines.last_rpm instead.
--
