-- Fix Challenge Progress Insert Issue
-- This migration ensures that update_challenge_progress() can insert/update records
-- by using SET LOCAL to disable RLS within the function execution

-- Recreate update_challenge_progress function with RLS bypass
