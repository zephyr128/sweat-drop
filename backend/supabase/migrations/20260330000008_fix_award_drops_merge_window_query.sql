-- Migration: 20260330000008_fix_award_drops_merge_window_query.sql
-- Description: Fix merge window query in award_drops() anti-split logic.
--   Old: v_session.started_at >= s2.started_at (too broad, matched overlapping sessions)
--   New: s2.ended_at <= v_session.started_at (correct: prior session must have ended before current started)
